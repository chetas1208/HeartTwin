...
export interface CaseRecord {
  ...
  simulation_result?: SimulationVisualization | Record<string, unknown> | null
  recovery_scenarios?: RecoveryScenario[] | Array<Record<string, unknown>> | null
  status: string
...
export interface OperateRequest {
  operating_environment?: Partial<OperatingEnvironment> | null
}

export interface SimulateRecoveryRequest {
  recovery_config?: RecoveryConfig | null
  scenarios?: RecoveryConfig[] | null
}
